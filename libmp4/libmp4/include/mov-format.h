...
#define MOV_FLAG_COSTUM_FASTSTART 0x00000004 //自定义的 moov在前面的 录制中不断更新moov的
#define MOV_FLAG_COSTUM_CONTINUEE 0x00000008
#define MOV_FLAG_COSTUM_WRITZEROS 0x00000010
#define MOV_FLAG_COSTUM_WRITESLOW 0x00000020
