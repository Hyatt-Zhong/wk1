...
#else
#define EV_LOG_GENERIC_EVENT(...)
#define EV_LOG_CONN_EVENT(...)
#define EV_LOG_PACKET_IN(...)
#define EV_LOG_ACK_FRAME_IN(...)
#define EV_LOG_STREAM_FRAME_IN(...)
#define EV_LOG_CRYPTO_FRAME_IN(...)
#define EV_LOG_WINDOW_UPDATE_FRAME_IN(...)
#define EV_LOG_BLOCKED_FRAME_IN(...)
#define EV_LOG_STOP_WAITING_FRAME_IN(...)
#define EV_LOG_CONNECTION_CLOSE_FRAME_IN(...)
#define EV_LOG_GOAWAY_FRAME_IN(...)
#define EV_LOG_RST_STREAM_FRAME_IN(...)
#define EV_LOG_STOP_SENDING_FRAME_IN(...)
#define EV_LOG_PADDING_FRAME_IN(...)
#define EV_LOG_PING_FRAME_IN(...)
#define EV_LOG_PACKET_CREATED(...)
#define EV_LOG_PACKET_SENT(...)
#define EV_LOG_PACKET_NOT_SENT(...)
#define EV_LOG_GENERATED_STREAM_FRAME(...)
#define EV_LOG_UPDATED_STREAM_FRAME(...)
#define EV_LOG_GENERATED_CRYPTO_FRAME(...)
#define EV_LOG_GENERATED_ACK_FRAME(...)
#define EV_LOG_GENERATED_PATH_CHAL_FRAME(...)
#define EV_LOG_GENERATED_PATH_RESP_FRAME(...)
#define EV_LOG_GENERATED_NEW_CONNECTION_ID_FRAME(...)
#define EV_LOG_GENERATED_STOP_WAITING_FRAME(...)
#define EV_LOG_GENERATED_STOP_SENDING_FRAME(...)
#define EV_LOG_CREATE_CONN(...)
#define EV_LOG_HSK_COMPLETED(...)
#define EV_LOG_SESSION_RESUMPTION(...)
#define EV_LOG_VER_NEG(...)
#endif
