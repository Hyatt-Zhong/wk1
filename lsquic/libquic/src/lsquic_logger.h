...
#else
#define LSQ_LOG_ENABLED_EXT(level, module) (0)
#endif
...
#   define LSQ_LOG1CS(level, ...) do {                                       \
        if (LSQ_LOG_ENABLED(level))                                          \
            lsquic_logger_log1(level, LSQLM_CONN_STATS, __VA_ARGS__);        \
    } while (0)
...
#else
#   define LSQ_LOG3(level, ...)
#   define LSQ_LOG2(level, ...)
#   define LSQ_LOG2C(level, ...)
#   define LSQ_LOG1(level, ...)
#   define LSQ_LOG1C(level, ...)
#   define LSQ_LOG1CS(level, ...)
#   define LSQ_LOG0(level, ...)
#   define LSQ_LOG0C(level, ...)
#endif
